...
const Blog = () => {
  ...
  const blogEntries = [
    ...
    "While still in the process of translating everything to React.js, we focused on our tasks. Jeremiah kept working on the backend to make sure everything would run smoothly during integration. As a team, we met up twice to go over future ideas and improvements, and we made sure to stay in sync about our strengths and challenges. After making some solid progress, we reassigned tasks: Saniyah started working on the dashboard and homepage, Hannah focused on the sign-up/sign-in features, and Jeremiah continued building out the database for both the front-end and back-end. Javon focused on implementing our blog page into the project. Overall, this week was productive and full of momentum.",
